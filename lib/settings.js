...
exports.initWithConfigContent = (configContent, keyVaultAccessConfig, customLogger, exceptionLogger, wait = false) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (wait) {
        yield decryptObjectInSequence(decrypt, config);
    }
    else {
