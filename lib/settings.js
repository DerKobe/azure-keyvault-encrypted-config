...
exports.setLogger = exports.getConfig = exports.initWithConfigContent = exports.initKeyVault = void 0;
...
exports.initKeyVault = (keyVaultAccessConfig) => {
    const { tenant, clientId, clientSecret, keyIdentifier, algorithm } = keyVaultAccessConfig;
    return new KeyVault_1.KeyVault(tenant, clientId, clientSecret, keyIdentifier, algorithm);
};
exports.initWithConfigContent = (configContent, keyVaultAccessConfig, customLogger, exceptionLogger, decryptInSequenceAndUseLocalCache = false) => {
    ...
    const { tenant, clientId, clientSecret, keyIdentifier, algorithm } = keyVaultAccessConfig;
    const keyVault = new KeyVault_1.KeyVault(tenant, clientId, clientSecret, keyIdentifier, algorithm);
    if (customLogger) {
