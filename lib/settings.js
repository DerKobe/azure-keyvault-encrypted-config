    ...
    for (const k in obj) {
        if (obj.hasOwnProperty(k) && typeof obj[k] === 'object') {
            ...
            if (k.endsWith(POSTFIX_ENCRYPTED)) {
                ...
                semaphors.push((0, QuerablePromise_1.makeQuerablePromise)(promiseDecrypt));
            }
                ...
                semaphors.push((0, QuerablePromise_1.makeQuerablePromise)(promiseDecryptBig));
            }
...
const initWithConfigContent = (configContent, keyVaultAccessConfig, customLogger, exceptionLogger, decryptInSequenceAndUseLocalCache = false) => {
    ...
    if (customLogger) {
        (0, exports.setLogger)(customLogger);
    }
    let keyVault;
    ...
    if (decryptInSequenceAndUseLocalCache) {
        semaphors.push((0, QuerablePromise_1.makeQuerablePromise)(decryptObjectInSequence(decrypt, config)));
    }
    else {
